...
def rsurf_q2i(L1: int, L2: int) -> Dict[Tuple[int, int], int]:
    r"""
    Creates a dictionary mapping qubit coordinates to integer labels. Note that this
    mapping is based on the lowest integer label and is different than might be
    expected based on geometry of the lattice.
